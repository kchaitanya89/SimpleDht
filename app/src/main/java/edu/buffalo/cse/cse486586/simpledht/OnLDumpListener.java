...
public class OnLDumpListener implements OnClickListener {

	private static final String TAG = OnLDumpListener.class.getName();
	...
	public OnLDumpListener(TextView _tv, ContentResolver _cr) {
		mTextView = _tv;
