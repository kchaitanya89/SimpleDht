...
public class OnGDumpListener implements OnClickListener {

	private static final String TAG = OnGDumpListener.class.getName();
	...
	public OnGDumpListener(TextView _tv, ContentResolver _cr) {
		mTextView = _tv;
